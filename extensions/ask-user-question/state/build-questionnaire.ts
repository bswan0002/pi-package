...
import { type QuestionData, SENTINEL_LABELS } from "../tool/types";
import {
	type BoundGlobalBinding,
	type BoundPerTabBinding,
	globalBinding,
	perTabBinding,
} from "../view/component-binding";
import { ChatRowView } from "../view/components/chat-row-view";
import { MultiSelectView } from "../view/components/multi-select-view";
import { OptionListView } from "../view/components/option-list-view";
import { PreviewBlockRenderer } from "../view/components/preview/preview-block-renderer";
import type { PreviewPaneProps } from "../view/components/preview/preview-pane";
import { PreviewPane } from "../view/components/preview/preview-pane";
import { SubmitPicker } from "../view/components/submit-picker";
import { TabBar } from "../view/components/tab-bar";
import type { WrappingSelectItem, WrappingSelectTheme } from "../view/components/wrapping-select";
import { DialogView } from "../view/dialog-builder";
import { QuestionnairePropsAdapter } from "../view/props-adapter";
import type { StatefulView } from "../view/stateful-view";
import type { TabBodyHeights, TabComponents } from "../view/tab-components";
import type { InputBuffer } from "./input-buffer";
import type { PerTabSelector } from "./selectors/contract";
import { selectActivePreviewPaneIndex } from "./selectors/derivations";
import {
	selectChatRowProps,
	selectDialogProps,
